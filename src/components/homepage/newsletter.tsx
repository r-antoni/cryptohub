...
const Newsletter = () => {
  return (
    <section className='flex justify-center items-center gap-10 bg-gray-100 px-10 py-10 rounded-lg'>
      <div className='flex flex-col items-start'>
        <h2 className='text-2xl'>Stay on top of crypto. All the time, any time.</h2>
